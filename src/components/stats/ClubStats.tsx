    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="rounded-xl border border-zinc-200 bg-white p-3 text-center">
          ...
          <p className="text-lg font-bold text-zinc-900">{stats.total_members}</p>
          <p className="text-[10px] text-zinc-500">Members</p>
        </div>
        <div className="rounded-xl border border-zinc-200 bg-white p-3 text-center">
          <Trophy className="mx-auto mb-1 h-4 w-4 text-[#1B5E20]" />
          <p className="text-lg font-bold text-zinc-900">{stats.total_games}</p>
          <p className="text-[10px] text-zinc-500">Games</p>
        </div>
        <div className="rounded-xl border border-zinc-200 bg-white p-3 text-center">
          <TrendingUp className="mx-auto mb-1 h-4 w-4 text-[#1B5E20]" />
          <p className="text-lg font-bold text-zinc-900">{Math.round(stats.club_win_rate)}%</p>
      ...
      {stats.most_active.length > 0 && (
        <div className="mt-3">
          <p className="mb-1.5 text-xs font-medium text-zinc-500">Most Active This Month</p>
