...
export function PushNotificationManager({
  ...
  if (loading) {
    return (
      <div className={cn("rounded-2xl border border-[#0A2E12]/10 bg-white p-5", className)}>
  ...
  if (permission === "unsupported") {
    return (
      <div className={cn("rounded-2xl border border-[#0A2E12]/10 bg-[#0A2E12]/[0.03] p-5", className)}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div
            className={cn(
              ...
              isSubscribed ? "bg-[#1B5E20]/10" : "bg-[#0A2E12]/5"
            )}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className={isSubscribed ? "text-[#1B5E20]" : "text-[#3D5A3E]"}
            >
        ...
        <button
          ...
          className={cn(
            ...
            isSubscribed
              ? "border border-[#0A2E12]/10 bg-white text-[#3D5A3E] hover:bg-[#0A2E12]/[0.03]"
