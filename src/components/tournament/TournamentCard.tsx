  ...
  return (
    <Link href={`/tournament/${tournament.id}`}>
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        className={cn(
          "rounded-2xl border border-zinc-800 bg-zinc-900/80 p-4 transition-colors hover:border-zinc-700",
          "cursor-pointer"
        )}
      >
        ...
        <h3 className="mb-1 font-bold text-zinc-100">{tournament.name}</h3>
