  ...
  if (!clubId) {
    if (isOwnProfile) {
      return (
        <Link
          href="/settings"
          className="mt-2 inline-flex items-center gap-1.5 rounded-full border border-dashed border-[#0A2E12]/10 px-3 py-1 text-xs text-[#3D5A3E] hover:border-[#0A2E12]/10 hover:text-[#3D5A3E]"
        >
