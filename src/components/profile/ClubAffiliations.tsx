        ...
        <div className="mb-3 rounded-xl border border-zinc-200 bg-white p-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-zinc-200 bg-zinc-50 pl-9 pr-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-[#1B5E20] focus:outline-none focus:ring-1 focus:ring-[#1B5E20]"
              autoFocus
            />
          </div>
            ...
            <div className="mt-2 max-h-48 overflow-y-auto space-y-1">
              {searchResults.map((club) => (
                <button
                  ...
                  className="flex w-full items-center justify-between rounded-lg p-2 text-left hover:bg-zinc-50 disabled:opacity-50"
                >
                ...
                <div className="min-w-0 flex-1">
                  {club ? (
                    <Link
                      ...
                      className="text-sm font-medium text-zinc-900 hover:text-[#1B5E20] truncate block"
                    >
                      {club.name}
                    </Link>
                  ) : (
