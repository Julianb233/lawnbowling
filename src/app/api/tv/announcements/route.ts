...
export async function GET(req: NextRequest) {
  ...
  if (error) {
    return apiError(error, "GET /api/tv/announcements", 500);
  }
...
export async function POST(req: NextRequest) {
  ...
  if (error) {
    return apiError(error, "POST /api/tv/announcements", 500);
  }
...
export async function DELETE(req: NextRequest) {
  ...
  if (error) {
    return apiError(error, "DELETE /api/tv/announcements", 500);
  }
