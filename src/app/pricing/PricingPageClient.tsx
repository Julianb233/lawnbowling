...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "No. The Lawnbowling app is free for individual players. Only clubs pay for premium features. Players benefit from better tournament management, scoring, and draw generation through their club's subscription.",
  },
];
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                title: "Stats & History",
                desc: "Track every game, end, and score. See who's improving and who's on a winning streak.",
              },
              {
              ...
              },
              {
                ...
                desc: "Track member insurance status and integrate with your club's coverage requirements.",
              },
            ].map((feature, i) => (
              <motion.div
                key={feature.title}
