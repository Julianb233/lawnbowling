    ...
    <div className="min-h-screen bg-[#FEFCF9] overflow-hidden">
      ...
      <section className="relative mx-auto max-w-6xl px-6 pb-24">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-2xl border border-[#1B5E20] bg-white shadow-xl shadow-[#1B5E20]/10 p-8">
      ...
      <section className="relative mx-auto max-w-4xl px-6 pb-16">
        <div className="flex flex-col items-center justify-center gap-6 sm:flex-row sm:gap-12">
          <div className="flex items-center gap-3 text-zinc-500"><BadgeCheck className="h-6 w-6 text-[#1B5E20]" /><span className="text-sm font-semibold uppercase tracking-wider">Licensed</span></div>
          <div className="flex items-center gap-3 text-zinc-500"><Lock className="h-6 w-6 text-[#1B5E20]" /><span className="text-sm font-semibold uppercase tracking-wider">Secure Payments</span></div>
          <div className="flex items-center gap-3 text-zinc-500"><Building2 className="h-6 w-6 text-[#1B5E20]" /><span className="text-sm font-semibold uppercase tracking-wider">500+ Facilities</span></div>
        </div>
      </section>
