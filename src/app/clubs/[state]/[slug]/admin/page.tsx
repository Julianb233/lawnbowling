...
export default function ClubAdminDashboard() {
    ...
    return (
      <div className="min-h-screen bg-[#0A2E12]/[0.03] flex items-center justify-center">
        <div className="text-center">
          <div className="mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-2 border-[#0A2E12]/10 border-t-emerald-500" />
          <p className="text-sm text-[#3D5A3E]">Loading club dashboard...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#0A2E12]/[0.03] flex items-center justify-center p-4">
        <div className="max-w-md w-full rounded-2xl border border-[#0A2E12]/10 bg-white p-8 text-center">
          ...
          <h1 className="text-xl font-bold text-[#0A2E12]">Access Denied</h1>
  ...
  if (error && !club) {
    return (
      <div className="min-h-screen bg-[#0A2E12]/[0.03] flex items-center justify-center p-4">
        <div className="max-w-md w-full rounded-2xl border border-[#0A2E12]/10 bg-white p-8 text-center">
          <h1 className="text-xl font-bold text-[#0A2E12]">Error</h1>
          <p className="mt-2 text-sm text-[#3D5A3E]">{error}</p>
          <Link
            href="/clubs"
            className="mt-6 inline-flex items-center gap-2 rounded-xl bg-[#0A2E12] px-6 py-3 text-sm font-bold text-white hover:bg-[#0A2E12] transition-colors"
          >
              ...
              <button
                ...
                className={`inline-flex items-center gap-1.5 shrink-0 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
                  activeTab === tab.key
                    ...
                    : "text-[#3D5A3E] hover:bg-[#0A2E12]/5 hover:text-[#2D4A30]"
                }`}
              >
                {tab.icon}
                {tab.label}
            ...
            <section className="rounded-2xl border border-[#0A2E12]/10 bg-white p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button
                  ...
                  className="flex items-center gap-3 rounded-xl border border-[#0A2E12]/10 p-4 text-left hover:border-[#0A2E12]/10 hover:bg-[#0A2E12]/[0.03] transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-3 rounded-xl border border-[#0A2E12]/10 p-4 text-left hover:border-[#0A2E12]/10 hover:bg-[#0A2E12]/[0.03] transition-colors"
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0A2E12]/5">
              ...
              <section className="rounded-2xl border border-amber-200 bg-amber-50 p-6">
                ...
                <div className="space-y-3">
                  {pendingMembers.map((member) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-[#0A2E12]/5 flex items-center justify-center text-sm font-bold text-[#3D5A3E]">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-lg border border-[#0A2E12]/10 px-3 py-1.5 text-xs font-medium text-[#3D5A3E] hover:bg-[#0A2E12]/[0.03] transition-colors"
                        >
            ...
            <section className="rounded-2xl border border-[#0A2E12]/10 bg-white p-6">
              ...
              {activeMembers.length === 0 ? (
                <div className="text-center py-8">
                  <Users className="mx-auto h-12 w-12 text-[#3D5A3E]" />
                  <p className="mt-2 text-sm text-[#3D5A3E]">
          ...
          <div className="space-y-6">
            ...
            {tournaments.length === 0 ? (
              <div className="rounded-2xl border border-[#0A2E12]/10 bg-white p-12 text-center">
                <Trophy className="mx-auto h-12 w-12 text-[#3D5A3E]" />
                <h3 className="mt-4 text-lg font-bold text-[#0A2E12]">
                  No Tournaments Yet
                </h3>
              ...
              <div className="space-y-3">
                {tournaments.map((tournament) => (
                  <div
                    key={tournament.id}
                    className="rounded-2xl border border-[#0A2E12]/10 bg-white p-5 hover:border-[#0A2E12]/10 transition-colors"
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        <h3 className="text-base font-bold text-[#0A2E12]">
                          {tournament.name}
                        </h3>
                        <div className="mt-1 flex items-center gap-2 text-sm text-[#3D5A3E]">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-xl border border-[#0A2E12]/10 py-3 px-4 text-sm text-[#0A2E12] placeholder:text-[#3D5A3E] focus:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-[#0A2E12]/10 py-3 px-4 text-sm text-[#0A2E12] placeholder:text-[#3D5A3E] focus:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 resize-none"
                  />
                </div>
...
function StatCard({
  ...
  return (
    <div className="rounded-2xl border border-[#0A2E12]/10 bg-white p-4 text-center">
      <div className="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-xl bg-[#0A2E12]/[0.03]">
        {icon}
      </div>
...
function MemberRow({
  ...
  return (
    <div className="flex items-center justify-between rounded-xl border border-[#0A2E12]/10 bg-[#0A2E12]/[0.03]/50 p-3">
      <div className="flex items-center gap-3">
        <div className="h-9 w-9 rounded-full bg-[#0A2E12]/5 flex items-center justify-center text-sm font-bold text-[#3D5A3E]">
          {member.player?.display_name?.[0]?.toUpperCase() ?? "?"}
        </div>
        <div>
      ...
      <div className="flex items-center gap-2">
        {compact ? (
          <span className="rounded-full bg-[#0A2E12]/5 px-2.5 py-0.5 text-xs font-medium text-[#3D5A3E] capitalize">
            {member.role}
          </span>
        ) : onRoleChange ? (
          <select
            ...
            className="rounded-lg border border-[#0A2E12]/10 px-2 py-1 text-xs text-[#2D4A30] focus:border-blue-300 focus:outline-none"
          >
