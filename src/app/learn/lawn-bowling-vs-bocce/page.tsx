    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-10 pb-12 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-zinc-600">
          They look similar at first glance, but lawn bowling and bocce ball are
          fundamentally different sports. Here is everything you need to know
      ...
      <section className="mx-auto max-w-4xl px-6 pb-12">
        <div className="rounded-2xl border border-[#1B5E20]/20 bg-[#1B5E20]/5 p-8 md:p-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-zinc-200 p-6">
            ...
            <ul className="space-y-2 text-[15px] text-zinc-600">
              ...
              <li>
                Commonwealth Games sport since 1930; strong in Australia, UK, NZ,
        ...
        <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-6 md:p-8">
          <div className="space-y-4 text-[16px] leading-relaxed text-zinc-700">
            <p>
              ...
              strategy, and the challenge of mastering bias. The curved delivery
              path adds a unique tactical dimension, and the club-based
              community offers structured competition and social events.
            </p>
            <p>
            ...
            <p>
              ...
              lawn bowling are often captivated by the added complexity of bias.
            </p>
          </div>
        </div>
      </section>
