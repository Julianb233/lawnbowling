          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-xl bg-blue-500 px-4 py-2.5 text-sm font-bold text-white hover:bg-blue-600 min-h-[44px] touch-manipulation"
              >
                Enter Scores
              </button>
            </div>
      ...
      <main className="mx-auto max-w-5xl px-4 py-6">
        {rounds.length === 0 ? (
          <div className="rounded-2xl bg-white border border-zinc-200 p-12 text-center">
            ...
            <button
              onClick={() => router.push(`/bowls/${tournamentId}/scores`)}
              className="mt-4 rounded-xl bg-blue-500 px-6 py-3 text-sm font-bold text-white hover:bg-blue-600 min-h-[48px] touch-manipulation"
            >
              Enter Scores
            </button>
          </div>
